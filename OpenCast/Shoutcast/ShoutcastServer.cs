...
namespace OpenCast.Shoutcast
{
    public class ShoutcastServer
    {
        ...
        public void Start()
        {
            ...
            Console.WriteLine("[INFO] Server started on {0}:{1} ({0}:{2} for control)", this.BindAddress, this.BindPort, this.BindPort + 1);
        }
        ...
        {
            Console.WriteLine("[INFO] Client accepted (control)");
        ...
        {
            Console.WriteLine("[INFO] Client accepted (listener)");
